...
import { USER_QUALIFICATION_DOCUMENT_FETCHED_SUCCESSFULLY } from 'App/Helpers/GeneralPurpose/CustomMessages/UserQualificationDocumentMessages'
...
export default class UserQualificationDocumentsController {
  constructor(private userQualificationDocumentService: UserQualificationDocumentService) {}

  public async index({ response, params }: HttpContextContract) {
    const qualificationDocuments =
      await this.userQualificationDocumentService.getUserQualificationDocumentByUserIdentifier(
        params.userId
      )
