...
import { WORK_EXPERIENCE_FETCHED_SUCCESSFULLY } from 'App/Helpers/GeneralPurpose/CustomMessages/WorkExperienceMessages'
...
export default class UserWorkExperiencesController {
  ...
  public async index({ response, params }: HttpContextContract) {
    const workExperiences = await this.workExperienceService.getWorkExperienceByUserIdentifier(
      params.userId
    )
